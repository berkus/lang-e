...
/*  A Bison parser, made from bin.y  */
...
static const short yyrhs[] = {    -1,
    10,    11,     0,    10,    12,     0,    17,    16,     0,     8,
    13,     9,     0,     0,    14,    13,     0,    15,    13,     0,
     6,     0,     5,     0,     4,     0,     3,     0,     7,     0
};

#if YYDEBUG != 0
static const short yyrline[] = { 0,
    23,    24,    25,    42,    44,    46,    47,    48,    50,    51,
    52,    53,    54
};

static const char * const yytname[] = {   "$","error","$illegal.","TEXT","HEX",
"BINST","INST","ARGS","'{'","'}'","list","def","act","specs","inst","binst",
"text","args",""
};
#endif

static const short yyr1[] = {     0,
    10,    10,    10,    11,    12,    13,    13,    13,    14,    15,
    15,    16,    17
};
...
static const short yypact[] = {-32768,
     0,-32768,    -3,-32768,-32768,     3,-32768,-32768,-32768,     1,
    -3,    -3,-32768,-32768,-32768,-32768,-32768,     9,-32768
};

static const short yypgoto[] = {-32768,
-32768,-32768,    -7,-32768,-32768,-32768,-32768
};
...
static const short yytable[] = {    18,
     7,     8,     9,    16,    17,    13,     2,     3,    19,    15
};

static const short yycheck[] = {     0,
     4,     5,     6,    11,    12,     3,     7,     8,     0,     9
};
...
case 9:
#line 50 "bin.y"
{ strcpy(name[nisn++],yytext); ;
    break;}
case 10:
#line 51 "bin.y"
{ strcpy(bin[nbin++], yytext); ;
    break;}
case 11:
#line 52 "bin.y"
{ strcpy(bin[nbin++], htob(yytext)); ;
    break;}
case 12:
#line 53 "bin.y"
{ strcpy(text, yytext); ;
