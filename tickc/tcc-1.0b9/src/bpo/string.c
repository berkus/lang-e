/* $Id: string.c,v 1.2 1997/12/11 01:26:15 maxp Exp $ */

/* This code is adapted from lcc, by Chris Fraser and David Hanson */
...
static char buf[BUFSZ], *bp;
static char *limit = &buf[BUFSZ];
