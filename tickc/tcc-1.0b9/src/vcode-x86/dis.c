 ...
 * HISTORY
 * $Log: dis.c,v $
 * Revision 1.2  1997/11/28 22:50:24  maxp
 * Added support for simplescalar.
 * Cleaned up vcode-x86 to build on linux.
 * Started icode/rcc support for x86/linux.
 *
 * Revision 1.1.1.1  1997/10/30 18:38:33  maxp
 * vcode-x86
 *
...
void __disassemble_region (unsigned int start, unsigned int len) {
  char line[80];
